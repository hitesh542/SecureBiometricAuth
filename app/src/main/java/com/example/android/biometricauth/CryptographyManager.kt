...
interface CryptographyManager {
     ...
     */
    fun getInitializedCipherForEncryption(keyName: String, initializationVector: ByteArray?): Cipher
...
private class CryptographyManagerImpl : CryptographyManager {
    ...
    override fun getInitializedCipherForEncryption(keyName: String, initializationVector: ByteArray?): Cipher {
